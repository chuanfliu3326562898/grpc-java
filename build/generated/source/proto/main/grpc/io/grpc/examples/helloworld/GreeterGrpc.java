...
public final class GreeterGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.grpc.examples.helloworld.HelloRequest2,
      io.grpc.examples.helloworld.HelloReply2> getSayHelloAgainMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHelloAgain",
      requestType = io.grpc.examples.helloworld.HelloRequest2.class,
      responseType = io.grpc.examples.helloworld.HelloReply2.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.grpc.examples.helloworld.HelloRequest2,
      io.grpc.examples.helloworld.HelloReply2> getSayHelloAgainMethod() {
    io.grpc.MethodDescriptor<io.grpc.examples.helloworld.HelloRequest2, io.grpc.examples.helloworld.HelloReply2> getSayHelloAgainMethod;
      ...
      synchronized (GreeterGrpc.class) {
        if ((getSayHelloAgainMethod = GreeterGrpc.getSayHelloAgainMethod) == null) {
          GreeterGrpc.getSayHelloAgainMethod = getSayHelloAgainMethod = 
              io.grpc.MethodDescriptor.<io.grpc.examples.helloworld.HelloRequest2, io.grpc.examples.helloworld.HelloReply2>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "helloworld.Greeter", "SayHelloAgain"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.grpc.examples.helloworld.HelloRequest2.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.grpc.examples.helloworld.HelloReply2.getDefaultInstance()))
  ...
  public static abstract class GreeterImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHelloAgain(io.grpc.examples.helloworld.HelloRequest2 request,
        io.grpc.stub.StreamObserver<io.grpc.examples.helloworld.HelloReply2> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                io.grpc.examples.helloworld.HelloRequest2,
                io.grpc.examples.helloworld.HelloReply2>(
  ...
  public static final class GreeterBlockingStub extends io.grpc.stub.AbstractStub<GreeterBlockingStub> {
    ...
    /**
     */
    public io.grpc.examples.helloworld.HelloReply2 sayHelloAgain(io.grpc.examples.helloworld.HelloRequest2 request) {
      return blockingUnaryCall(
  ...
  public static final class GreeterFutureStub extends io.grpc.stub.AbstractStub<GreeterFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<io.grpc.examples.helloworld.HelloReply2> sayHelloAgain(
        io.grpc.examples.helloworld.HelloRequest2 request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_SAY_HELLO_AGAIN:
          serviceImpl.sayHelloAgain((io.grpc.examples.helloworld.HelloRequest2) request,
              (io.grpc.stub.StreamObserver<io.grpc.examples.helloworld.HelloReply2>) responseObserver);
          break;
        default:
